...
(function() {
if (dwr.engine._getObject("MF_DashboardManager") == undefined) {
var p;
...
p.storeUserAppListingSortOrder = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_DashboardManager', 'storeUserAppListingSortOrder', arguments);
};
...
p.contactCustomerSupport = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'MF_DashboardManager', 'contactCustomerSupport', arguments);
};
...
p.archiveProjects = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_DashboardManager', 'archiveProjects', arguments);
};
...
p.getUserAppListingSortOrder = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_DashboardManager', 'getUserAppListingSortOrder', arguments);
};

dwr.engine._setObject("MF_DashboardManager", p);
}
})();
