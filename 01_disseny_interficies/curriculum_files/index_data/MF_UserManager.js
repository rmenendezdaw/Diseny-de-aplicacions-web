...
(function() {
if (dwr.engine._getObject("MF_UserManager") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'MF_UserManager', 'deleteCollaborator', arguments);
};
...
p.updateCollaboratorAll = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'MF_UserManager', 'updateCollaboratorAll', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_UserManager', 'addCollaborator', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_UserManager', 'sendInvite', arguments);
};
...
dwr.engine._setObject("MF_UserManager", p);
}
})();
