...
(function() {
if (dwr.engine._getObject("MF_UserManagerFlash") == undefined) {
var p;
...
p.deleteCollaborator = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'MF_UserManagerFlash', 'deleteCollaborator', arguments);
};
...
p.updateCollaboratorAll = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'MF_UserManagerFlash', 'updateCollaboratorAll', arguments);
};
...
p.addCollaborator = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'MF_UserManagerFlash', 'addCollaborator', arguments);
};
...
p.addCollaborator = function(p0, p1, p2, p3, p4, p5, p6, callback) {
return dwr.engine._execute(p._path, 'MF_UserManagerFlash', 'addCollaborator', arguments);
};
...
p.addCollaborator = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'MF_UserManagerFlash', 'addCollaborator', arguments);
};
...
p.sendInvite = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'MF_UserManagerFlash', 'sendInvite', arguments);
};
...
p.sendInvite = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'MF_UserManagerFlash', 'sendInvite', arguments);
};

dwr.engine._setObject("MF_UserManagerFlash", p);
}
})();
