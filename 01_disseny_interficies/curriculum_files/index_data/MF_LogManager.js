...
p.logReadonlyTrashProject = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'MF_LogManager', 'logReadonlyTrashProject', arguments);
};
...
p.sendNotification2 = function(p0, p1, p2, p3, p4, p5, p6, callback) {
return dwr.engine._execute(p._path, 'MF_LogManager', 'sendNotification2', arguments);
};
...
p.sendNotification2 = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'MF_LogManager', 'sendNotification2', arguments);
};
...
p.sendNotification = function(p0, p1, p2, p3, callback) {
