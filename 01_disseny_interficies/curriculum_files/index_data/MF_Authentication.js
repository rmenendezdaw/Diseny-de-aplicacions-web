...
p.checkGoogleAppsUser = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'checkGoogleAppsUser', arguments);
};
...
p.canModifyStore = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'canModifyStore', arguments);
};
...
p.canModifyUIPackAdmin = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'canModifyUIPackAdmin', arguments);
};
...
p.canModifyUIPack = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'canModifyUIPack', arguments);
};
...
p.getProjectCount = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'getProjectCount', arguments);
};
...
p.deleteSecureKeyHash = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'deleteSecureKeyHash', arguments);
};
