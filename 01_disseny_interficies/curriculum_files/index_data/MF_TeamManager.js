...
(function() {
if (dwr.engine._getObject("MF_TeamManager") == undefined) {
var p;
...
p.IsGmail = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_TeamManager', 'IsGmail', arguments);
};
...
p.addMember = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_TeamManager', 'addMember', arguments);
};
...
p.deleteMember = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_TeamManager', 'deleteMember', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_TeamManager', 'list', arguments);
};

dwr.engine._setObject("MF_TeamManager", p);
}
})();
