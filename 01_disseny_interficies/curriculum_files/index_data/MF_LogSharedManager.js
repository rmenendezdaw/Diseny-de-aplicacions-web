...
(function() {
if (dwr.engine._getObject("MF_LogSharedManager") == undefined) {
var p;
...
p.countLog = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_LogSharedManager', 'countLog', arguments);
};
...
p.deleteLog = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_LogSharedManager', 'deleteLog', arguments);
};
...
p.readAll = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_LogSharedManager', 'readAll', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_LogSharedManager', 'add', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_LogSharedManager', 'list', arguments);
};

dwr.engine._setObject("MF_LogSharedManager", p);
}
})();
