...
c.$dwrClassMembers = {};
c.$dwrClassMembers.prevlabels = {};
c.$dwrClassMembers.prevcounts = {};
...
p.updateCommentAlert = function(p0, p1, p2, callback) {
...
p.getThumbnail = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_AccountManager', 'getThumbnail', arguments);
};
...
p.removeProfileImage = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_AccountManager', 'removeProfileImage', arguments);
};
...
p.saveSSOSettings = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_AccountManager', 'saveSSOSettings', arguments);
};
...
p.getSSOSettings = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_AccountManager', 'getSSOSettings', arguments);
};
...
p.getSSOSettingsForEmail = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_AccountManager', 'getSSOSettingsForEmail', arguments);
};
...
p.uploadProfilePhoto = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_AccountManager', 'uploadProfilePhoto', arguments);
};
