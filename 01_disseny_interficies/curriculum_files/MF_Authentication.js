...
p.isEnterpriseUser = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'isEnterpriseUser', arguments);
};
...
p.checkRecaptchaToken = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'checkRecaptchaToken', arguments);
};




p.pruneEmailThrottleCheck = function(callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'pruneEmailThrottleCheck', arguments);
};
...
p.addSecureTransferToInitiate = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'addSecureTransferToInitiate', arguments);
};
...
p.addSecureKeyHashByApp = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'addSecureKeyHashByApp', arguments);
};
